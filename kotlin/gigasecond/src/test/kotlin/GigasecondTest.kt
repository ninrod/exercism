...
class GigasecondTest {
    ...
    @Test
    fun jtime() {
        val d = LocalDate.of(2015,Month.MARCH, 27)
        val g = Gigasecond(d)
        val exp = LocalDateTime.of(2046 , Month.DECEMBER, 3, 1, 46, 40)
        assertEquals(exp, g.date)
    }
    ...
    fun atime() {
        ...
        val g = Gigasecond(d)
        val exp = LocalDateTime.of(2013, Month.OCTOBER, 3, 1, 46, 40)
        assertEquals(exp, g.date)
    }
